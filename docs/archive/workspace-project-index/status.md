...
Archive note: this status file was moved here from `/Users/xvadur_mac/Workspace/projects/jakub-astro` on 30 May 2026. It is stale legacy metadata. Current status lives in `../../PROJECT_STATUS.md`.
...
- Migrovaný a uprataný Astro projekt v lokálnej ceste `~/Projects/Jakub_Astro`.
